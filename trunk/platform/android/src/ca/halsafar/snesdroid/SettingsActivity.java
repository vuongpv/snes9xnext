...
public class SettingsActivity extends PreferenceActivity implements
          OnSharedPreferenceChangeListener, DownloadListener, DecompressListener
{
     ...
     protected void onCreate(Bundle savedInstanceState)
     {
          ...
          customPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
               public boolean onPreferenceClick(Preference preference)
              {
                    try
                    {
                        ...
                        final int result = PreferenceFacade.MENU_INPUT_CONFIG;
          ...
          customPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
              ...
              {                                      
                   ...
                   edit.putBoolean(PreferenceFacade.PREF_USE_DEFAULT_INPUT,
                             true);
         ...
         // add on click for custom keys
          ...
          customPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
              ...
              {                                      
                    try
                    {
                        ...
                        final int result = PreferenceFacade.MENU_CUSTOM_KEYS;
                        startActivityForResult(intent, result);
                    }
                    catch (Exception e)
                    {
          ...
          customPref = (Preference) findPreference("resetShaderPref");
          customPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
               public boolean onPreferenceClick(Preference preference)
              {
          ...
          // add onclick for download shaders
          customPref = (Preference) findPreference("downloadShaderPref");
          customPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
               public boolean onPreferenceClick(Preference preference)
              {
                   ...
                   String outFile = PreferenceFacade.getShaderDir(getApplicationContext()) + "/shaders.zip";
                   DownloadFile downloadFile = new DownloadFile(outFile, getApplicationContext(), _progressDialog, SettingsActivity.this);
                   downloadFile.execute("https://sites.google.com/site/shinhalsafar/files/shaders.zip");
          ...
          */
          ...
          checkPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
               public boolean onPreferenceClick(Preference preference)
              {
                    ...
                    {
                         SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                         boolean enableGameGenie = prefs.getBoolean(PreferenceFacade.PREF_ENABLE_GAME_GENIE, false);
          ...
          customPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
          {
               public boolean onPreferenceClick(Preference preference)
              {
                    ...
                    myIntent.putExtra(FileChooser.EXTRA_START_DIR, 
                                      PreferenceFacade.getRomDir(getApplicationContext()));
                    myIntent.putExtra(FileChooser.EXTRA_EXTENSIONS,
                              "");
                    final int result = PreferenceFacade.MENU_DIR_SELECT;
                    startActivityForResult(myIntent, result);

                    _dirKeyChanging = PreferenceFacade.PREF_DIR_ROMS;
               ...
               Intent data)
     {
          ...
          if (requestCode == PreferenceFacade.MENU_INPUT_CONFIG)
          {
               Log.d(LOG_TAG, "onActivityResult(INPUT_CONFIG)");
          }
          else if (requestCode == PreferenceFacade.MENU_DIR_SELECT)
          {
          ...
          else if (requestCode == PreferenceFacade.MENU_SHADER_SELECT)
          {
               ...
               customPref.setSummary(shaderFile);
